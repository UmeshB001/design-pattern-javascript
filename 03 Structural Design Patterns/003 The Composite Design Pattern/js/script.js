//Take account of multiple object with the same API
//Recognize the need to control all elements at the same time
//See how this pattern is ideal in recursive elements that are "chained" to each other
