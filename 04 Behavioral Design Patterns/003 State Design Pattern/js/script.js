//Explore different states of an application demanding different reaction
//Check out how complexity increases with increased condition
//Extract the state to separate objects, enabling reduction of code complexity
(function(win, $){
